...
# patternsleuth_exe = f''
# game_exe_path = f''
# patternsleuth_aes_command = f'"{patternsleuth_exe}" scan --resolver AESKeys --path "{game_exe_path}"'
# patternsleuth_build_configuration_command = f'"{patternsleuth_exe}" scan --resolver BuildConfiguration --path "{game_exe_path}"'
# patternsleuth_engine_version_command = f'"{patternsleuth_exe}" scan --resolver EngineVersion --path "{game_exe_path}"'
